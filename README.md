...
Most environment variables should already be included in the stack's Compose file, but secrets should NOT be included in there directly.
Instead, they should be added to Portainer directly under the `Environment variables` section of the `Add stack` page.
